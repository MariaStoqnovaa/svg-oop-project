...
public class Controller {
    ...
    public String execute(String input) {
        ...
        if (command.equals("create")) {
            if (parts.length < 2) return "Please specify a shape type.";
        ...
        if (command.equals("erase")) {
            if (parts.length < 2) return "Please provide a shape number.";
            try {
        ...
        if (command.equals("within")) {
            if (parts.length < 3) return "Please provide a region type and parameters.";
            ...
            try {
                ...
                if (regionType.equals("rectangle") && parts.length >= 6) {
                    ...
                    return "Unknown region type or insufficient parameters. Use 'rectangle' or 'circle'.";
                }
